...
* **`Exclusive`** – The listing **is not** scheduled to be posted on the MLS.
* **`Coming Soon`** – These listings **do have** an MLS listing date.
* **`Assignment`** – All assignment properties will receive this as the primary tag.
