...
<meta name="og:title" content="Access Listing Analytics with FirstList (formerly Knokd)" />
...
All FirstList (formerly Knokd) agent users with at least 1 listing can access analytics by following these steps:
...
<Screenshot 
  ...
  alt="Analytics view for FirstList (formerly Knokd) listings"
/>
