...
Your [external network](/getting-started/grow-your-network#your-extended-network) will consist of all agents that share a working area with you. 

To sign up as an agent:

1. From the <a href="https://www.knokd.ca/" target="_blank">Knokd Home Page</a>, click **Get Started**.
2. Enter your email and complete the signup process.
